...
class DiffPublicationsCallback extends DiffUtil.Callback {
    ...
    DiffPublicationsCallback(@NonNull List<Publication> oldPublications, @NonNull List<Publication> newPublications) {
